...
class DividasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create divida" do
    assert_difference('Divida.count') do
      post dividas_url, params: { divida: { cliente_id: @divida.cliente_id, empresa_id: @divida.empresa_id } }
    end
  ...
  test "should update divida" do
    patch divida_url(@divida), params: { divida: { cliente_id: @divida.cliente_id, empresa_id: @divida.empresa_id } }
